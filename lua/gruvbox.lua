---@class Gruvbox-@field config GruvboxConfig
...
local function get_colors()
  ...
  local color_groups = {
    dark = {
      ...
      --
      faded_aqua = p.faded_aqua,
      faded_blue = p.faded_blue,
      light_aqua = p.light_aqua,
      neutral_orange = p.neutral_orange,
      dark_aqua = p.dark_aqua,
      dark_aqua_soft = p.dark_aqua_soft,
      faded_orange = p.faded_orange,
      --
      ...
      -- custom
      alt_blue = p.alt_blue,
      faded_red = p.faded_red,
      light_red = p.light_red,
      gray = p.gray,
      white = p.white,
      sea_green = p.sea_green,
      medium_green = p.medium_green,
    },
    light = {
      bg0 = p.light0,
      bg1 = p.light1,
...
local function get_groups()
  ...
  local groups = {
    ...
    GruvboxWhite = { fg = colors.white, bold = config.bold },
    GruvboxGreen = { fg = colors.green },
    GruvboxGreenBold = { fg = colors.bright_green, bold = true },
    ...
    GruvboxSeaGreen = { fg = colors.sea_green },
    GruvboxAltBlue = { fg = colors.alt_blue },
    ...
    GruvboxRedSign = { fg = colors.bright_red, reverse = config.invert_signs }
    ...
    TabLineFill = { fg = colors.bg6, bg = colors.bg1, reverse = config.invert_tabline },
    TabLineSel = { fg = colors.white, bg = colors.bg3, reverse = config.invert_tabline },
    ...
    Search = { fg = colors.yellow, bg = "#000000", reverse = config.inverse },
    IncSearch = { fg = colors.bright_red, bg = colors.bg0, reverse = config.inverse },
    CurSearch = { link = "IncSearch" },
    QuickFixLine = { link = "GruvboxPurple" },
    Underlined = { fg = colors.blue, underline = config.underline },
    StatusLine = { fg = colors.bg5, bg = colors.fg1, reverse = config.inverse },
    StatusLineNC = { fg = colors.bg5, bg = colors.fg4, reverse = config.inverse },
    ...
    Todo = { fg = colors.fg1, bg = "#464c4e", italic = config.italic.comments },
    ...
    Operator = { fg = colors.neutral_red, italic = config.italic.operators },
    Keyword = { link = "GruvboxRed" },
    Identifier = { link = "GruvboxWhite" },
    Delimiter = { link = "GruvboxWhite" },
    Function = { link = "GruvboxSeaGreen" },
    PreProc = { link = "GruvboxAqua" },
    Include = { link = "GruvboxRed" },
    Define = { link = "GruvboxRed" },
    ...
    TelescopeNormal = { link = "GruvboxWhite" },
    TelescopeSelection = { bg = colors.medium_green, fg = colors.white },
    TelescopeSelectionCaret = { link = "GruvboxRed" },
    TelescopeMultiSelection = { link = "GruvboxGray" },
    TelescopeBorder = { link = "GruvboxGray" },
    TelescopePromptBorder = { link = "GruvboxGray" },
    TelescopeResultsBorder = { link = "GruvboxGray" },
    TelescopePreviewBorder = { link = "GruvboxGray" },
    TelescopeMatching = { link = "GruvboxGreenBold" },
    TelescopePromptPrefix = { link = "GruvboxRed" },
    TelescopePrompt = { link = "TelescopeNormal" },
    CmpItemAbbr = { link = "GruvboxWhite" },
    CmpItemAbbrDeprecated = { link = "GruvboxFg1" },
    CmpItemAbbrMatch = { link = "GruvboxGreenBold" },
    CmpItemAbbrMatchFuzzy = { link = "GruvboxGreenBold" },
    CmpItemMenu = { link = "GruvboxGray" },
    CmpItemKindText = { link = "GruvboxWhite" },
    ...
    CmpItemKindModule = { link = "GruvboxPurple" },
    ...
    pythonFunction = { link = "GruvboxRed" },
    pythonDecorator = { link = "GruvboxRed" },
    pythonInclude = { link = "GruvboxRed" },
    pythonImport = { link = "GruvboxRed" },
    ...
    ocamlConstructor = { link = "GruvboxYellow" },
    ...
    -- ["@function.call"] = { link = "GruvboxWhite" },
    -- ["@function.method.call"] = { link = "GruvboxWhite" },
    -- ["@function.builtin"] = { link = "GruvboxWhite" },
    ["@function.macro"] = { link = "Macro" },
    ["@function.method"] = { link = "Function" },
    ["@method"] = { link = "Function" },
    ["@method.call"] = { link = "Function" },
    ["@constructor"] = { link = "Type" },
    -- ["@constructor"] = { link = "GruvboxWhite" },
    ["@parameter"] = { link = "GruvboxWhite" },
    ...
    ["@attribute"] = { link = "GruvboxWhite" },
    ["@attribute.builtin"] = { link = "GruvboxWhite" },
    ["@field"] = { link = "GruvboxWhite" },
    ["@property"] = { link = "Identifier" },
    ["@variable"] = { link = "GruvboxWhite" },
    ["@variable.builtin"] = { link = "GruvboxWhite" },
    ["@constant"] = { link = "GruvboxWhite" },
    ...
    ["@lsp.type.class"] = { fg = colors.neutral_red },
